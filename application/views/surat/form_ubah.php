        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-8">
              ...
              <form action="<?php echo base_url(); ?>surat/edit_surat/<?php echo $surat['id'] ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                  ...
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input required="" type="text" class="form-control" name="nomor_surat" placeholder="" value="<?php echo $surat['nomor_surat'] ?>" >
                      </div>
                    </div>
                    ...
                    <div class="col col-md-3">
                      ...
                      <div class="col-12 col-md-9">
                        <input required="" type="text" class="form-control" name="judul" placeholder="" value="<?php echo $surat['judul'] ?>" >
                      </div>
                    </div>
